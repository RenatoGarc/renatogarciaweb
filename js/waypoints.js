(function() {
    ...
    !function(t, e) {
        ...
        return o = n(r), f = t.call(r, "ontouchstart") >= 0, s = {
            horizontal: {},
            vertical: {}
        }, c = 1, a = {}, u = "waypoints-context-id", p = "resize.waypoints", v = "scroll.waypoints", y = 1, w = "waypoints-waypoint-ids", g = "waypoint", m = "waypoints", i = function() {
            function t(t) {
                var e = this;
            ...
            function t(t, e, r) {
                ...
                }), this.$element = t, this.element = t[0], this.axis = r.horizontal ? "horizontal" : "vertical", this.callback = r.handler, this.context = e, this.enabled = r.enabled, this.id = "waypoints" + y++, this.offset = null, this.options = r, e.waypoints[this.axis][this.id] = this, s[this.axis][this.id] = this, o = null != (i = this.element[w]) ? i : [], o.push(this.id), this.element[w] = o
            }
            ...
            init: function(t, e) {
                ...
                return e = n.extend({}, n.fn[g].defaults, e), null == (r = e.handler) && (e.handler = t), this.each(function() {
                    var t,
                        ...
                        o,
                        s;
                    return t = n(this), o = null != (s = e.context) ? s : n.fn[g].defaults.context, n.isWindow(o) || (o = t.closest(o)), o = n(o), r = a[o[0][u]], r || (r = new i(o)), new l(t, r, e)
                }), n[m]("refresh"), this
            },
            disable: function() {
            ...
            aggregate: function(t) {
                var e,
                    r,
                    o;
                return e = s, t && (e = null != (o = a[n(t)[0][u]]) ? o.waypoints : void 0), e ? (r = {
                    horizontal: [],
                    vertical: []
            ...
            _filter: function(t, e, r) {
                var o,
                    i;
                return (o = a[n(t)[0][u]]) ? (i = [], n.each(o.waypoints[e], function(t, e) {
