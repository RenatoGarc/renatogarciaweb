function init() {
    if (document.body) {
        var e = document.body,
            ...
            o = e.scrollHeight;
        if (root = document.compatMode.indexOf("CSS") >= 0 ? t : e, activeElement = e, initdone = !0, top != self)
            frame = !0;
...
function overflowingAncestor(e) {
    ...
    do {
        ...
        } else if (e.clientHeight + 10 < e.scrollHeight && (overflow = getComputedStyle(e, "").getPropertyValue("overflow-y"), "scroll" === overflow || "auto" === overflow))
            return setCache(t, e)
