        ...
        n = {
            ...
            validatorTypes: {
                callback: {
                    ...
                    validate: function(a, e, i) {
                        if (i.lastValue === e && i.lastFinished)
                            return !i.lastValid;
                        if (i.lastFinished === !0) {
            ...
            builtInValidators: {
                ...
                validemail: {
                    ...
                    message: "E-mail no válido.<!-- data-validator-validemail-message to override -->"
                },
                passwordagain: {
                    name: "Passwordagain",
                    type: "match",
